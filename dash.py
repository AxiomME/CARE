	...
	if topic in ['Display geographic correlations','Income or livelihoods related correlations','Display Security correlations','Display other correlations']:
		...
		for i in range(len(quest)):
			...
			if quest.iloc[i]['graphtype']=='violin':
				...
				fig1.update_layout(legend_title_side='top',legend_font_size=14,legend_title_font_size=14,showlegend=True,title=None)
				...
				fig2.update_layout(legend_title_side='top',legend_font_size=15,legend_title_font_size=16,showlegend=True,title=None)
